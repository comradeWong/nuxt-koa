  ...
  <div class="m-nav">
    <ul class="nav">
      ...
      <li class="list bd">
        ...
        <dl>
          <dd>
            <nuxt-link to="/center">美团餐饮商户中心</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="/center">登录商家中心</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="/center">美团智能收银</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="/center">我想合作</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="/center">手机免费开店</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="/center">餐饮代理商招募</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="/center">商家申请开票</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="/center">免费合作美团排队</nuxt-link>
          </dd>
        </dl>
      </li>
      <li class="list site">
